...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWZrZmF3YXMiLCJhIjoiY2t6cGpuaTNlM2lxdDJ1bnkyaXp4bDV0NCJ9.57V70J-pXt5HMDgX_k7x4Q';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //Adding a new marker inside of mapbox.

    new mapboxgl.Marker({
      element: el,
      //bottom of the el(pin) which is going to be located at the exact gps location.
      anchor: 'bottom' //rem coordinates is an arr of longitude and latitude respectively, that's exactly what mapbox want.
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.success === true) {
              ...
              (0, _alert.showAlert)('success', 'Logged In Successfully'); // After 1.5s loading the homepage, coz after reloading only the user data is loaded to the header.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51KY0q7SCRw9YrTeDRgCfVj2oHVcOG3GJaQdIGn95gt25CegKig0N7tj1Y5IfedCbUWbzFEy5cwPF6wZFzXQXC7Ls00KweqNzyn'); // 1) Get checkout session from the API
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //Chapter 203(Here we are creating a multi-part form data)

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value); //.files return an array, since there is only one...

    form.append('photo', document.getElementById('photo').files[0]); //our AJAX call using axios will auto recognize 'form' as object.
